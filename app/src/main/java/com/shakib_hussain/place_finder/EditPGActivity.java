...
public class EditPGActivity extends AppCompatActivity implements ListenerEdit {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_pgactivity);
    ...
    private void setAdapter() {
        ...
        imageAdapter = new ImageAdapter(EditPGActivity.this, mArrayUri, this);
    ...
    private void setChips() {
        ...
        autoCompleteTextView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                Chip chip = new Chip(EditPGActivity.this);
                ...
                Toast.makeText(EditPGActivity.this, curItem + " Selected...",
